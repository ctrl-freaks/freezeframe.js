...
module.exports = require("freezeframe");
...
// EXTERNAL MODULE: external "freezeframe"
var external_freezeframe_ = __webpack_require__("d79f");
var external_freezeframe_default = /*#__PURE__*/__webpack_require__.n(external_freezeframe_);
...
/* harmony default export */ var Freezeframevue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    if (this.$slots.default) {
      this.$freezeframe = new external_freezeframe_default.a(this.$el, this.options);
    } else if (this.src) {
      this.$freezeframe = new external_freezeframe_default.a(this.$refs.img, this.options);
    }
